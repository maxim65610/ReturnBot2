...
public class CommonMessageConstants {
    ...
    public static final String DEFAULT_RESPONSE = "Привет, этот бот может помочь тебе понять куда ты хочешь поступить, " +
            ...
            "узнать свои данные после регитрации /userInfo";
    /**
    ...
    public static final String REGISTRATION_COMMAND_RESPONSE = " Здравствуйте, начинаем. Всего будет 4 пункта, которые " +
            "вы должны указать: имя, фамилию, класс, почту. Введите имя:\n";
}
